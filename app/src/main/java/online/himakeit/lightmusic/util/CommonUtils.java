...
public class CommonUtils {
    ...
    private static PackageInfo getPackageInfo(Context ctx) {
        ...
        try {
            ...
            info = packageManager.getPackageInfo(ctx.getPackageName(), PackageManager.GET_CONFIGURATIONS);
            return info;
    ...
    public static String getDeviceInfo() {
        ...
        builder.append("APP.VERSION = " + getAPPVersionCode(AppContext.getAppContext()) + "\n");
        builder.append("\n" + "log:" + "\n");
...
//    }
    ...
    public static void main(String[] args) {
        System.out.println(encode("song_id,title,author,album_title,pic_big,pic_small,havehigh,all_rate,charge,has_mv_mobile,learn,song_source,korean_bb_song"));
    }
